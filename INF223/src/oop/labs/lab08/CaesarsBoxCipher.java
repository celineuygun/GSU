package oop.labs.lab08;

import java.awt.*;
import java.awt.event.*;
import java.util.Locale;

public class CaesarsBoxCipher implements WindowListener, ActionListener {
    ...
    public CaesarsBoxCipher() {
        ...
        plain.setText("Şifrelemek istediğiniz\nmetni giriniz.");
        ciphered.setText("Şifresini çözmek\nistediğiniz metni giriniz.");
    ...
    public static void main(String[] args) {
        CaesarsBoxCipher app = new CaesarsBoxCipher();
    }
    ...
    public static String editText(String s) {
        ...
        return alphaString.toLowerCase(Locale.ROOT);
    }
